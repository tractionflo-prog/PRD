...
export function IconDoc({ className, ...p }: IconProps) {
  return (
    <svg
      className={className}
      width="22"
...
export function IconTimer({ className, ...p }: IconProps) {
  return (
    <svg
      className={className}
      width="22"
...
export function IconChat({ className, ...p }: IconProps) {
  return (
    <svg
      ...
      {...p}
    >
      <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l2.3-6.2A8.5 8.5 0 0 1 3.4 7.5 8.38 8.38 0 0 1 7.2 3.7 8.5 8.5 0 0 1 12 3c4.6 0 8.4 3.5 9 8z" />
    </svg>
  );
}
